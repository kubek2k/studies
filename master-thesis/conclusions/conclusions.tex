...
Coraz wiêcej systemów opartych jest o paradygmat SOA, co przynosi wymierne korzy¶ci w postaci np. lu¼nych powi±zañ pomiêdzy us³ugami, ich u³atwionej integracji oraz konieczno¶ci stosowania kontraktów.
Badanie wydajno¶ci us³ug realizuj±cych procesy biznesowe z u¿yciem jêzyka BPEL jest bardzo przydatne, poniewa¿ pozwala m.in. znale¼æ s³abe punkty tworzonej aplikacji (ang. bottlenecks), analizowaæ zachowanie siê konkretnych wywo³añ procesów biznesowych oraz wyszukiwaæ b³êdy i niepoprawnie dzia³aj±ce procesy.
...
W przypadku u¿ywania platformy OSGi\cite{concl:osgi} (system modu³ów dla jêzyka Java) bezpo¶rednie wsparcie dla jêzyka BPEL bêdzie umo¿liwia³a nowa wersja serwera GlassFish 3.0\cite{concl:glassfishv3}. Poniewa¿ regu³y instrumentacji OpenESB s± ju¿ utworzone, mamy mo¿liwo¶æ badania i analizowania wydajno¶ci us³ug zrealizowanych z u¿yciem jêzyka BPEL w dowolnym ¶rodowisku OSGi.
...
Mnogo¶æ postawionych w pracy problemów oraz mo¿liwo¶ci rozwoju stworzonego oprogramowania, ¶wiadczy o szerokim spektrum mo¿liwych kontynuacji badañ w tej dziedzinie.
